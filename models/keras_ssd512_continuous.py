...
def ssd_512(image_size,
    ...
    Arguments:
        ...
        n_clabels (int): The number of continuous labels.
    ...
    # Output shape of `clabels`: `(batch, height, width, n_boxes * n_clabels)`
    conv4_3_norm_mbox_clabel = Conv2D(n_boxes[0] * n_clabels, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4_3_norm_mbox_clabel')(conv4_3_norm)
    fc7_mbox_clabel = Conv2D(n_boxes[1] * n_clabels, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='fc7_mbox_clabel')(fc7)
    conv6_2_mbox_clabel = Conv2D(n_boxes[2] * n_clabels, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv6_2_mbox_clabel')(conv6_2)
    conv7_2_mbox_clabel = Conv2D(n_boxes[3] * n_clabels, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv7_2_mbox_clabel')(conv7_2)
    conv8_2_mbox_clabel = Conv2D(n_boxes[4] * n_clabels, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv8_2_mbox_clabel')(conv8_2)
    conv9_2_mbox_clabel = Conv2D(n_boxes[5] * n_clabels, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv9_2_mbox_clabel')(conv9_2)
    conv10_2_mbox_clabel = Conv2D(n_boxes[6] * n_clabels, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv10_2_mbox_clabel')(conv10_2)
    ...
    # Reshape the clabel predictions, yielding 3D tensors of shape `(batch, height * width * n_boxes, n_clabels)`
    conv4_3_norm_mbox_clabel_reshape = Reshape((-1, n_clabels), name='conv4_3_norm_mlabel_conf_reshape')(conv4_3_norm_mbox_clabel)
    fc7_mbox_clabel_reshape = Reshape((-1, n_clabels), name='fc7_mbox_conf_labelhape')(fc7_mbox_clabel)
    conv6_2_mbox_clabel_reshape = Reshape((-1, n_clabels), name='conv6_2_mbox_clabel_reshape')(conv6_2_mbox_clabel)
    conv7_2_mbox_clabel_reshape = Reshape((-1, n_clabels), name='conv7_2_mbox_clabel_reshape')(conv7_2_mbox_clabel)
    conv8_2_mbox_clabel_reshape = Reshape((-1, n_clabels), name='conv8_2_mbox_clabel_reshape')(conv8_2_mbox_clabel)
    conv9_2_mbox_clabel_reshape = Reshape((-1, n_clabels), name='conv9_2_mbox_clabel_reshape')(conv9_2_mbox_clabel)
    conv10_2_mbox_clabel_reshape = Reshape((-1, n_clabels), name='conv10_2_mbox_labelf_reshape')(conv10_2_mbox_clabel)
    ...
    # Output shape `clabels_concat`: (batch, n_boxes_total, n_clabels)
    mbox_clabel = Concatenate(axis=1, name='mbox_clabel')([conv4_3_norm_mbox_clabel_reshape,
                                                         fc7_mbox_clabel_reshape,
                                                         conv6_2_mbox_clabel_reshape,
                                                         conv7_2_mbox_clabel_reshape,
                                                         conv8_2_mbox_clabel_reshape,
                                                         conv9_2_mbox_clabel_reshape,
                                                         conv10_2_mbox_clabel_reshape])
    ...
    predictions = Concatenate(axis=2, name='predictions')([mbox_conf_softmax, mbox_clabel, mbox_loc, mbox_priorbox])
