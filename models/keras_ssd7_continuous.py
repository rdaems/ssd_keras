...
def build_model(image_size,
    ...
    clabels4 = Conv2D(n_boxes[0] * n_clabels, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                      kernel_regularizer=l2(l2_reg), name='clabels4')(conv4)
    clabels5 = Conv2D(n_boxes[1] * n_clabels, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                      kernel_regularizer=l2(l2_reg), name='clabels5')(conv5)
    clabels6 = Conv2D(n_boxes[2] * n_clabels, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                      kernel_regularizer=l2(l2_reg), name='clabels6')(conv6)
    clabels7 = Conv2D(n_boxes[3] * n_clabels, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                      kernel_regularizer=l2(l2_reg), name='clabels7')(conv7)
    ...
    clabels4_reshaped = Reshape((-1, n_clabels), name='clabels4_reshape')(clabels4)
    clabels5_reshaped = Reshape((-1, n_clabels), name='clabels5_reshape')(clabels5)
    clabels6_reshaped = Reshape((-1, n_clabels), name='clabels6_reshape')(clabels6)
    clabels7_reshaped = Reshape((-1, n_clabels), name='clabels7_reshape')(clabels7)
    ...
    clabels_concat = Concatenate(axis=1, name='clabels_concat')([clabels4_reshaped,
                                                                 clabels5_reshaped,
                                                                 clabels6_reshaped,
                                                                 clabels7_reshaped])
    ...
    predictions = Concatenate(axis=2, name='predictions')([classes_softmax, clabels_concat, boxes_concat, anchors_concat])
