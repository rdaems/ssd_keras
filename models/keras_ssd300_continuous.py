...
def ssd_300(image_size,
    ...
    conv4_3_norm_mbox_clabel_reshape = Reshape((-1, n_clabels), name='conv4_3_norm_mbox_clabel_reshape')(conv4_3_norm_mbox_clabel)
    fc7_mbox_clabel_reshape = Reshape((-1, n_clabels), name='fc7_mbox_clabel_reshape')(fc7_mbox_clabel)
