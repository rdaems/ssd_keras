...
from data_generator.object_detection_2d_data_generator_continuous import DataGeneratorContinuous as DataGenerator
...
class Evaluator:
    ...
    def __init__(self,
                 ...
                 pred_format={'class_id': 0, 'conf': 1, 'clabel_value': 2, 'xmin': 3, 'ymin': 4, 'xmax': 5, 'ymax': 6},
                 gt_format={'class_id': 0, 'clabel_value': 1, 'xmin': 2, 'ymin': 3, 'xmax': 4, 'ymax': 5}):
        '''
        Arguments:
    ...
    def match_predictions(self,
        ...
        for class_id in range(1, self.n_classes + 1):
            ...
            num_chars_per_image_id = len(str(predictions[0][0])) + 50 # Keep a few characters buffer in case some image IDs are longer than others.
